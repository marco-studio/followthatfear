      ...
      <div>
        ...
        <div className="text-center p-8 max-w-md md:max-w-lg m-auto mt-16 lg:max-w-xl lgx:max-w-2xl lgx:mt-24">
          ...
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            Follow that Fear Podcast is a podcast dedicated to empowering you
            follow that fear, take action before you're ready, pursue what your
            heart is calling you to do, and build confidence one step at a time.
            Hosted by Cat Del Carmen.
          </div>
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl" />
